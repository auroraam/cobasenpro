...
❓Kenapa Waterfall❓
- Mengingat waktu yang terbatas dalam developing, yaitu satu semester yang belum include dengan proyek lainnya.
- Semua tahapan sudah didefinisikan sejak awal, memudahkan perencanaan dan meningkatkan efisiensi.
- Lebih mudah diimplementasikan daripada agile.

---

## ✅ Tujuan dari *SmartSched*

SmartSched bertujuan untuk membantu pengguna mengelola tugas, jadwal, dan prioritas dengan otomatisasi berbasis AI, sehingga meningkatkan produktivitas tanpa perlu mengatur semuanya secara manual.

---

## Pengguna potensial dari produk dan kebutuhan para pengguna tersebut
### 👥 Pengguna Potensial
- Mahasiswa → Kesulitan mengatur jadwal kuliah, tugas, dan kegiatan lainnya.
- Pekerja Profesional → Memerlukan alat untuk mengelola tugas harian dengan efisien.
- Freelancer → Butuh task manager yang fleksibel untuk mengatur banyak proyek sekaligus.

### ✉ Kebutuhan Pengguna
- Task manager yang otomatis menyusun prioritas.
- Pengingat adaptif berdasarkan urgensi tugas.
